...
namespace SocialWelfarre.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Designations")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Designations")] Designation designation)
        {
