...
namespace SocialWelfarre.Data.Migrations
{
    ...
    [Migration("20250426075949_DisasterKits")]
    partial class DisasterKits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialWelfarre.Models.DisasterKit", b =>
                {
                    ...
                    b.Property<int>("StockIn_BoxesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialWelfarre.Models.StockIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialWelfarre.Models.DisasterKit", b =>
                {
                    ...
                    b.HasOne("SocialWelfarre.Models.StockIn", "Stock_Ins")
                        .WithMany()
                        .HasForeignKey("Stock_InsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StockOut_By");

                    b.Navigation("Stock_Ins");
                });
